...
<p>Choose your own tiles from any local supplier — we're happy to recommend showrooms in Torre del Mar and Vélez-Málaga — or tell us the look you want and we'll source options within your budget. Either way you get a written quote per square metre with preparation and materials itemised.</p>
"""
...
<p>You get an itemised quote, a start date and a realistic duration. We protect the rest of your home, manage our own waste, and keep water off for the shortest time possible — usually you're never without a working bathroom overnight when the property has a second one.</p>
"""
...
"reforms": _svc("reforms",
    ...
    "Complete and partial property reforms in Torre del Mar, Vélez-Málaga, Nerja and across the Axarquia. One team, itemised quotes, 12-month guarantee. Free quotes.",
    ...
    [("How much does a property reform cost in the Axarquia?",
      "It depends on scope and finish, but as a guide: a light cosmetic reform (paint, floors, doors) starts from a few thousand euros per room, while full reforms of apartments typically run from €600–€1,000 per square metre. Every quote we give is itemised so you can adjust the scope to your budget."),
...
"tiling": _svc("tiling",
    ...
    "Professional floor, wall, bathroom and terrace tiling in Torre del Mar, Vélez-Málaga, Nerja and the Axarquia. Waterproofing done right. Free itemised quotes.",
    ...
    [("How much does tiling cost per square metre?",
      "Labour for standard-format floor tiling typically runs €25–€40 per m² in the Axarquia, with walls, large formats, natural stone and terraces priced higher due to preparation and cutting. Your quote itemises labour, preparation and materials separately."),
...
<section class="alt"><div class="container">
  ...
  <div class="grid c2">
    <div class="card"><div class="ico">✎</div><h3>Itemised written quotes</h3><p>Labour and materials listed line by line, so you always know where your budget goes. 50% deposit to book, balance only on completion.</p></div>
