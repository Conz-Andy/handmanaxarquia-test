...
<h2>Så arbetar vi</h2>
<p>Varje renovering börjar med ett kostnadsfritt besök och en skriftlig offert där arbete och material specificeras rad för rad, så att du ser exakt vart budgeten går. Vi tar 50 % handpenning för att boka in arbetet och beställa material; resten betalas först när jobbet är klart och du är nöjd. Oförutsedda problem — och äldre spanska hus gillar att gömma sådana — prissätts och godkänns alltid skriftligt innan vi fortsätter.</p>
...
<p>Med bas i Almayate utför vi renoveringar i Torre del Mar, Vélez-Málaga, Nerja, Torrox, Caleta de Vélez, Algarrobo och i hela Axarquía. Även lanthus och cortijos — vi känner väl till utmaningarna med tillfart, vatten och el på landsbygden.</p>
"""
...
<p>Välj plattor själv hos valfri lokal leverantör — vi rekommenderar gärna butiker i Torre del Mar och Vélez-Málaga — eller beskriv looken du vill ha så tar vi fram alternativ inom din budget. Oavsett vilket får du en skriftlig offert per kvadratmeter med förarbete och material specificerat.</p>
"""

BATHROOMS_PROSE = """
<h2>Kompletta badrumsrenoveringar</h2>
<p>Ett omodernt badrum drar ner helhetsintrycket av hela bostaden — och i uthyrningsbostäder är det det första gästerna fotograferar. Vi renoverar badrum i hela Axarquía från rivning till silikon: VVS, el, tätskikt, kakel, inredning och finish — allt av ett och samma team enligt en och samma tidplan.</p>
<ul class="tick">
...
<p>Du får en specificerad offert, ett startdatum och en realistisk tidplan. Vi skyddar resten av hemmet, tar hand om vårt eget byggavfall och stänger av vattnet så kort tid som möjligt — har bostaden ett andra badrum står du aldrig utan fungerande badrum över natten.</p>
"""
...
<li>Planlösningsändringar — väggar flyttas, köksöar byggs, öppen planlösning</li>
<li>Ny el med tillräckligt många kretsar för moderna apparater</li>
<li>VVS för diskhoar, diskmaskiner, vattenfilter och gashällar</li>
...
<p>Det mest efterfrågade jobbet i spanska radhus och lägenheter: att ta bort väggen mellan ett stängt kök och vardagsrummet. Rätt utfört — med konstruktionsbedömning, korrekt dimensionerad balk och bygglov där det krävs — förvandlar det både hur bostaden fungerar och vad den är värd.</p>
"""
...
"reforms": _svc("reforms",
    ...
    "Hel- och delrenoveringar i Torre del Mar, Vélez-Málaga, Nerja och hela Axarquía. Ett team, specificerade offerter, 12 månaders garanti. Kostnadsfri offert på svenska.",
    ...
    [("Vad kostar en renovering i Axarquía?",
      "Det beror på omfattning och standard, men som riktmärke: en enklare uppfräschning (målning, golv, dörrar) börjar på några tusen euro per rum, medan helrenoveringar av lägenheter normalt ligger på 600–1 000 € per kvadratmeter. Alla våra offerter är specificerade så att du kan anpassa omfattningen efter budgeten."),
...
"tiling": _svc("tiling",
    ...
    [("Vad kostar plattsättning per kvadratmeter?",
      "Arbetskostnaden för golvläggning i standardformat ligger normalt på 25–40 € per m² i Axarquía; väggar, storformat, natursten och terrasser kostar mer på grund av förarbete och kapning. Offerten specificerar arbete, förarbete och material separat."),
...
"bathrooms": _svc("bathrooms",
    ...
    [("Vad kostar en badrumsrenovering?",
      "En komplett renovering av ett badrum i normalstorlek ligger i Axarquía normalt på 4 500–9 000 € beroende på inredning och plattor; golvduschar och premiumval därutöver. Offerten specificerar allt så att du kan anpassa valen efter budget."),
     ("Hur länge är jag utan badrum?",
      "En typisk totalrenovering tar 7–12 arbetsdagar. Vattnet stängs bara av korta stunder, och har bostaden ett andra badrum står du aldrig utan över natten."),
...
"kitchens": _svc("kitchens",
    ...
    [("Vad kostar en köksrenovering?",
      "Förarbete och installation (allt utom stommar och vitvaror) ligger normalt på 3 000–7 000 € beroende på planlösningsändringar och ytskikt. Med stommar i mellanklass ingår hamnar kompletta kök i Axarquía oftast mellan 8 000 och 15 000 €."),
     ...
     ("Hur lång tid tar ett köksbyte?",
      "Utan planlösningsändringar: 1–2 veckor. Med flyttade väggar eller öppen planlösning: 3–5 veckor inklusive puts och torktider. Tidplan följer med offerten.")]),
}
...
<section><div class="container">
  <div class="sec-head">
    ...
    <h2>Hela Axarquía</h2>
    <p>Med bas i Almayate, några minuter från Torre del Mar — vi täcker Vélez-Málaga, Nerja, Torrox, Caleta de Vélez, Algarrobo, Cómpeta samt byarna och campon runt omkring.</p>
  </div>
</div></section>
{cta_band(lang, ui, u)}"""
...
PAGES["home"] = {"key": "home", "slug": "",
    ...
    "desc": "Professionell bygg- och renoveringsfirma i Axarquía, Costa del Sol: renoveringar, puts, tillbyggnader, kakel, badrum och kök. Kostnadsfria offerter. Vi talar svenska.",
    "body": home_body}
