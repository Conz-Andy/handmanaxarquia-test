...
<p>Välj plattor själv hos valfri lokal leverantör — vi rekommenderar gärna butiker i Torre del Mar och Vélez-Málaga — eller beskriv looken du vill ha så tar vi fram alternativ inom din budget. Oavsett vilket får du en tydlig skriftlig offert för jobbet.</p>
"""
...
<p>Du får en skriftlig offert, ett startdatum och en realistisk tidplan. Vi skyddar resten av hemmet, tar hand om vårt eget byggavfall och stänger av vattnet så kort tid som möjligt — har bostaden ett andra badrum står du aldrig utan fungerande badrum över natten.</p>
"""
...
"reforms": _svc("reforms",
    ...
    "Hel- och delrenoveringar i Torre del Mar, Vélez-Málaga, Nerja och hela Axarquía. Ett team, kostnadsfria skriftliga offerter, 12 månaders garanti. Kostnadsfri offert på svenska.",
    ...
    [("Vad kostar en renovering i Axarquía?",
      "Det beror på omfattning och standard, men som riktmärke: en enklare uppfräschning (målning, golv, dörrar) börjar på några tusen euro per rum, medan helrenoveringar av lägenheter normalt ligger på 600–1 000 € per kvadratmeter. Alla våra offerter är skriftliga så att du kan anpassa omfattningen efter budgeten."),
...
"tiling": _svc("tiling",
    ...
    [("Vad kostar plattsättning per kvadratmeter?",
      "Varje kakeljobb prissätts individuellt — priserna på plattor varierar enormt, och format, underlagets skick samt mängden förarbete och kapning påverkar alla kostnaden. Berätta hur stor ytan är och vilka plattor du tänker dig, så får du en kostnadsfri skriftlig offert."),
...
"bathrooms": _svc("bathrooms",
    ...
    [("Vad kostar en badrumsrenovering?",
      "En komplett renovering av ett badrum i normalstorlek ligger i Axarquía normalt på 4 500–9 000 € beroende på inredning och plattor; golvduschar och premiumval därutöver. Offerten visar tydligt vad som ingår så att du kan anpassa valen efter budget."),
...
def home_body(lang, ui):
  ...
  <p class="lead">Ett pålitligt team för renoveringar, tillbyggnader, puts, kakel, badrum och kök. Över 35 års erfarenhet — alltid i tid och inom budget. Vi talar svenska.</p>
  <div class="actions">
